...
public class FhcTripHotelCreateTest extends TestBase {
    ...
    public void test() throws InterruptedException {
        ...
        createPage.codeKutusu.sendKeys("1230");
        createPage.nameKutusu.sendKeys("Mehmet");
        createPage.adressKutusu.sendKeys("Arjantin");
        createPage.emailKutusu.sendKeys("mehmet@hotmail.com");
